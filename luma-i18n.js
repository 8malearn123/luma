...
(function(){
  ...
  const DICT={
    ...
    'من موهبةٍ… إلى علامةٍ فاخرة.':'From talent… to a luxury brand.',
    ...
    'للخبيرات المستقلات':'For independent experts','للصوالين والمراكز':'For salons & centers','ستاندر · للخبيرات المستقلات':'Standard · for independent experts',
    'الباقة الأساسية — كل ما تحتاجينه لبداية راقية.':'The standard plan — everything you need for an elegant start.',
    'التحليلات والأدوات الاحترافية — منظومة متكاملة تعمل عنكِ.':'Analytics and professional tools — a complete system working for you.',
    'سَناء ووَهَج للخبيرات المستقلات، وفَريد للصوالين والمراكز — اختاري ما يناسب مرحلتكِ، ورقّي متى شئتِ.':'Sanaa and Wahaj are for independent experts, Fareed for salons & centers — pick your stage and upgrade anytime.',
    'نظام إدارة صالون متكامل بذكاء اصطناعي.':'A complete AI-powered salon management system.',
    ...
    'الفواتير البيعية':'Sales Invoices','التسويق':'Marketing','المالية':'Finance','المحاسبة':'Accounting','موقع الصالون':'Salon Site','استوديو التصميم':'Design Studio','التقارير':'Reports','الفروع':'Branches','الإعدادات':'Settings',
