...
/* لا تُمنح الجلسة هنا: كان فتح الصفحة وحده يجعل أي زائر «مالكة صالون»
   ويمنحه صلاحية التعديل في المتجر. الجلسة تُنشأ من صفحة الدخول فقط،
   والحارس في رأس salon.html يتحقق منها قبل رسم اللوحة. */
const IC={
