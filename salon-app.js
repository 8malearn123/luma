...
SCREENS.branches=()=>{
  const B=[
    {n:'فرع الشاطئ',c:'جدة · حي الشاطئ',staff:4,chairs:6,st:'رئيسي',sc:'gold',rev:'52,400'},
    {n:'فرع الروضة',c:'جدة · حي الروضة',staff:3,chairs:4,st:'نشط',sc:'green',rev:'34,100'},
  ];
  return `
